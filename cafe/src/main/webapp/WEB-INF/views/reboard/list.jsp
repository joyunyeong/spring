...
$(document).ready(function(){
	...
	$(".viewBtn").click(function(){
		...
		$("#key").val("${key}");
		$("#word").val("${word}");
		$("#seq").val($(this).attr("data-seq")); // 밑에 data-seq 참고할 것!!
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr valign="bottom">
		<td nowrap>
			<img class="moveWriteBtn" src="${root}/img/board/btn_write_01.gif" width="64" height="22" border="0" align="absmiddle" alt="글쓰기">
		</td>
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
	...
	<tr valign="top">
		<td nowrap><img class="moveWriteBtn" src="${root}/img/board/btn_write_01.gif" width="64" height="22" border="0" align="absmiddle" alt="글쓰기"></td>
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
	...
	<tr>
		<td width="50%"></td>
		<td nowrap>
			<select name="key" class="inp" id="skey">
				<option value="subject">글제목
				<option value="name">글쓴이
				<option value="seq">글번호
			</select> 
			<span id="sear1"> 
				<input type="text" id="sword" name="query" size="22" class="inp" style="margin-top: -19px;"> 
			</span>
			<img src="${root}/img/board/sbtn_s.gif" width="32" height="18" border="0" align="absmiddle" alt="검색" id="searchBtn">
			
			<c:if test="${userInfo != null }"> 
			<img src="${root}/img/board/sbtn_mytext.gif" width="82" height="20" align="absmiddle" alt="내가 쓴 글 보기" id="myListBtn"><br>
			</c:if>
		</td>
