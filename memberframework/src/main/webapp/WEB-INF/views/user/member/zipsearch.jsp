	...
	$("#searchBtn").click(function() {
		$.ajax({
			...
			success : function(data) {
				...
				// for문이 끝나고 위에 문장을 뿌리자~
				// tr을 추가하는 개념은 append가 더 맞다 html보다는!!
				$("#zip_codeList").empty().append(view); // 기존에 있던거 지우고 append해라~ > html()쓰는거랑 같은개념이긴 함(덮어쓰기)
			}
		});
	});
});
